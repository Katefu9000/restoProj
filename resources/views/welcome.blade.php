<x-guest-layout>
        <!-- Main Hero Content -->
        <div
      class="container max-w-lg px-4 py-72 mx-auto text-left bg-center bg-no-repeat bg-cover md:max-w-none md:text-center"
      style="background-image: url('https://whyy.org/wp-content/uploads/2020/10/phillyparkingdining-hy10_slide-5ab9f7a904d2a4d3ff7bf463b9d6c18b95ab4cb0-1-768x512.jpg')">
      <h1
        ...
        <span class="inline md:block">le Restoran</span>
      </h1>
      ...
      <div class="flex flex-col items-center mt-12 text-center">
        <span class="relative inline-flex w-full md:w-auto ">
          <a href="{{ route('reservations.step.one') }}" type="button"
            class="inline-flex items-center justify-center px-6 py-3 text-base font-bold leading-6 text-white bg-green-600 rounded-full lg:w-full md:w-auto hover:bg-green-500 focus:outline-none">
        ...
        <div class="flex flex-wrap items-center sm:-mx-3">
          ...
          <div class="w-full md:w-1/2">
            <div class="w-full h-auto overflow-hidden rounded-md shadow-xl sm:rounded-xl">
              <img src="https://mediaproxy.salon.com/width/1200/height/675/https://media.salon.com/2010/06/chef_gordon_ramsay_calls_out_the_orders_during_the_first_dinner_service_on_tuesday_nights_hells_kitchen.jpg" />
            </div>
          </div>
        </div>
      </div>
      ...
      <div class="container items-center max-w-6xl px-4 px-10 mx-auto sm:px-20 md:px-32 lg:px-16">
        <div class="flex flex-wrap items-center -mx-3">
          ...
          <div class="w-full px-3 mb-12 lg:w-1/2 order-0 lg:order-1 lg:mb-0"><img
              ...
              src="https://i.pinimg.com/originals/55/ba/91/55ba91cec81e789eb56e19b4d3415884.png" alt="feature image"></div>
        </div>
      </div>
    </section>
